         ...
         <div className={style.flexWraper}>
            <div className={style.info}>
               ...
               <p className={style.text}>
                  ...
                  <span>
                     Decyzję o przyjęciu każdorazowo będziemy podejmować na podstawie kolejności zgłoszeń oraz naszych
                     możliwości odpowiedzi na potrzeby rodziny, dziecka oraz naszej społeczności.
                  </span>
